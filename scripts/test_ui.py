    ...
    async with async_playwright() as p:
        ...
        try:
            ...
            await page.evaluate('''() => {
                ...
                const file2 = new File([new Uint8Array(10)], "test2.jpg", { type: "image/jpeg" });
            ...
            print("Taking screenshot after drop...")
            os.makedirs('/home/jules/verification/screenshots', exist_ok=True)
            await page.screenshot(path='/home/jules/verification/screenshots/ui_layout_check_1.png')

            print("Clicking off the widget to render viewer...")
            await page.click("body", position={"x": 10, "y": 10})
            await page.wait_for_timeout(1000)
            await page.screenshot(path='/home/jules/verification/screenshots/ui_layout_check_2.png')
